...
interface IconProps extends React.SVGProps<SVGSVGElement> {
  name: 'business' | 'summary' | 'sparkles' | 'image' | 'copy' | 'download';
}
    ...
    case 'business':
      return (
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
          <path strokeLinecap="round" strokeLinejoin="round" d="M13.5 21v-7.5A.75.75 0 0 1 14.25 12h.75c.414 0 .75.336.75.75V21m-4.5 0v-6.75A.75.75 0 0 1 10.5 13.5h.75c.414 0 .75.336.75.75V21m-4.5 0v-4.5A.75.75 0 0 1 6.75 15h.75c.414 0 .75.336.75.75V21m-4.5 0h16.5M3.75 6.75h16.5M3.75 12h16.5m-16.5 5.25h16.5M3.75 17.25h16.5" />
        </svg>
      );
    case 'summary':
      return (
